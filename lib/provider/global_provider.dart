...
class GlobalProvider extends ChangeNotifier {
  ...
  int? selectedMerchantIndex;
  Position? currentPosition;
  bool itineraryStarted = false;
  bool? proximityToggled;
  bool qrCodeToggled = false;
  ...
  toggleQrCode() {
    qrCodeToggled = !qrCodeToggled;
    notifyListeners();
  }

  setToggleQrCode(bool value) {
    qrCodeToggled = value;
    notifyListeners();
  }

  setProximityToggle(bool? value) {
    proximityToggled = value;
    notifyListeners();
  }

  setItineraryStarted(bool value) {
    itineraryStarted = value;
    notifyListeners();
  }

  Itinerary getSelectedItinerary() {
    return itineraries.firstWhere((el) => el.id == selectedItineraryId);
  }

  setSelectedMerchantIndex(int? id) {
    selectedMerchantIndex = id;
    notifyListeners();
  }

  setSelectedItineraryId(int? id) {
